...
public class Graph {
    ...
    public Graph(long seedForWages, long seedForHabitats, int edgeWageSum, int minimalNumberOfHabitats, int maximumNumberOfHabitats, int graphSize, int infectingParameter)
    {
    ...
    private Graph(int[][] adjacencyMatrix, HashMap<Integer, Node> nodes)
    {
        this.adjacencyMatrix = adjacencyMatrix;
        this.nodes = nodes;
    }

    public Graph(ArrayList<Node> nodeArrayList, int[][] adjacencyMatrix)
    {
        this.adjacencyMatrix = adjacencyMatrix;
    ...
    public Graph getSubgraphWithUnvisitedNodes()
    {
        ...
        return new Graph(adjacencyMatrix, subgraphNodes);
    }
